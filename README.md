...
2. กด **พิมพ์ / PDF** — หน้าพิมพ์ใช้ตัวอักษรเดียวกับตัวอย่างบนจอ
3. ถ้าข้อความล้น A4 จะขึ้นแผ่นใหม่พร้อมโลโก้และหัวกระดาษ โดยไม่ตัดข้อย่อยกลางข้อ
4. เลือกกระดาษ A4 ตั้งระยะขอบน้อยที่สุด และปิดหัวท้ายหน้า
