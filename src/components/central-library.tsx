...
export function CentralLibrary() {
  return (
    <div className="mx-auto max-w-5xl space-y-4 px-4 py-6 sm:px-6">
      <div>
        <h1 className="text-lg font-semibold text-teal-950">คลังสัญญา Google Sheet</h1>
        <p className="text-sm text-muted-foreground">
          สัญญาทั้งหมดอยู่ที่ชีต sck-contact ไม่ใช้เซิร์ฟเวอร์ Node — หน้านี้สำหรับเปิดชีตโดยตรง
        </p>
      </div>
      <iframe
